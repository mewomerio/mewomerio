<div align="center">
  ...
  <h1>world I <span style="color:#ff6bcb;">MERIO</span></h1>
  <h3 style="color:#9b59b6;">Senior Fullstack Engineer • JS/TS • Cloud • DevOps</h3>

  <!-- QUICK FACTS -->
  <p>
    <img src="https://img.shields.io/badge/Role-Senior%20Fullstack-ff6bcb?style=for-the-badge" />
...
<div align="left">
  <img src="https://skillicons.dev/icons?i=godot,unreal" alt="GameDev stack" />
</div>

- **Engines**: Godot and Unreal Engine for prototyping and production-ready game features.
- **Gameplay systems**: player movement, combat loops, UI/HUD, save/load flows, interaction logic.
- **Technical focus**: performance optimization, clean architecture, reusable systems, tooling for faster iteration.

---

### 🎨 Illustration & 3D

- **Digital illustration**: concept art, UI/UX visuals, promo assets and style exploration.
- **3D workflows**: modeling, texturing, lighting, scene composition and real-time previews.
- **Production mindset**: balancing artistic quality with technical constraints and pipeline consistency.
